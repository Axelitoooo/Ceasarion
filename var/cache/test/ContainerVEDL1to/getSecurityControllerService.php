...
class getSecurityControllerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.oYvDZU_'] ?? $container->load('get_ServiceLocator_OYvDZUService'))->withContext('App\\Controller\\SecurityController', $container));
