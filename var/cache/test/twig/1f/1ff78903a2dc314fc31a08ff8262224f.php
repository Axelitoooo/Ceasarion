...
class __TwigTemplate_40ad9fa7bf9d2b684cf0ef0d667be8fd extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag"]) {
               ...
               class=\"badge badge-";
                // line 5
                echo (((twig_get_attribute($this->env, $this->source, $context["tag"], "name", [], "any", false, false, false, 5) == twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 5, $this->source); })()), "request", [], "any", false, false, false, 5), "query", [], "any", false, false, false, 5), "get", [0 => "tag"], "method", false, false, false, 5))) ? ("success") : ("secondary"));
                echo "\"
            >
                <i class=\"fa fa-tag\"></i> ";
                // line 7
...
", "blog/_post_tags.html.twig", "/Users/dodaymacbookpro/Documents/pro/freelance/adda/TMA/TP-PHP-GIT-TU/templates/blog/_post_tags.html.twig");
    }
}
