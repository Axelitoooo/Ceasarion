 ...
 */
class getUx_LiveComponent_AttributeHelperService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/ux-live-component/src/Util/TwigAttributeHelper.php';
