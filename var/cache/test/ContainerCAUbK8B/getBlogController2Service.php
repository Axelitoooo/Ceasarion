 ...
 */
class getBlogController2Service extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.4wAbWid'] ?? $container->load('get_ServiceLocator_4wAbWidService'))->withContext('App\\Controller\\BlogController', $container));
