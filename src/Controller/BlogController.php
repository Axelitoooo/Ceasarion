...
final class BlogController extends AbstractController
{
    ...
    public function commentNew(
        ...
        $comment = new Comment();
        $comment->setAuthor($user); // Set the author as the authenticated user
    ...
    #[Route('/search-results', name: 'blog_search_results', methods: ['GET'])]
    public function searchResults(Request $request, PostRepository $postRepository): Response
    {
        $query = $request->query->get('query', '');
        $results = $postRepository->searchByTitleAndContent($query);
